...
<div style="width: 90%; margin: auto;">
  <div style="display: flex; justify-content: space-between;"> 
     ...
     <a href="modtrash.php">
       <button class="btn-inactive"  style="border: none;background-color: white;height: 40px; margin-bottom: 10px;padding: 10px;box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1), 0 1px 3px rgba(0, 0, 0, 0.06);margin-top: 100px;width: 100px;"><i class="ri-printer-fill"></i>Trash</button>
     </a>
  ...
  <div class="grid">
    <div class="add-module-container" style="width: 220PX">
      ...
      <?php foreach ($modules as $module): ?>
        <div class="card" style="width: 220PX">
          ...
          <div style="display: flex; justify-content: space-around;gap:10px;"> 
            <a href="view2.php?id=<?php echo $module['module_id']; ?>" class="" style="background-color: #4682B4;padding: 10px;width: 50%;border-radius: 10px;color:white">Open</a><a href="removemod.php?id=<?php echo $module['module_id']; ?>" class="" style="background-color: lightgray;padding: 10px;width: 50%;border-radius: 10px;color:white">Delete</a>
          </div>
