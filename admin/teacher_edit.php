...
<?php 
     ...
     if (isset($_GET['id'])) {
        ...
        $stmtss = $conn->prepare("SELECT * FROM teacher where teacher_id=:id ");
...
<body style="background-color:#fff;font-family: Arial, sans-serif;">
    <div class="containerss" style="margin-top:80px;">
        <div class="headerss">
            ...
            <h1 style="margin-bottom:40px"> <a href="student.php"><i class="ri-arrow-left-line" style="margin-right:20px"></i></a>Teacher Information</h1>
            <button>Print</button>
        </div>
        <div class="profiless">
            <img src="<?php 
            ...
            <div class="infoss">
                ...
                <div class="extraterrestrial-menu">
                    <a href="#">Archive</a>
                    <a href="profile_edit.php?id=<?php echo $id; ?>">Edit</a>
                </div> 
            </div>
            </div>
        </div>
                ...
                <div class="info-grid">
                    ...
                    <div>
                        ...
                        <input type="text" name="first_name" 
                               value="<?php echo ucwords($firstname); ?>" required>
                    </div>

                    <div>
                        <label>Middle Name: </label>
                        <input type="text" name="middle_name" 
                               value="<?php echo ucwords($middlename); ?>" required>
                    </div>

                    <div>
                        <label>Last Name: </label>
                        <input type="text" name="last_name" 
                               value="<?php echo ucwords($lastname); ?>" required>
                    </div>
                    
                    <div>
                        <label>Preferred Name: </label>
                        <input type="text" name="preferred_name" value="<?php echo ucwords($firstname); ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_number" value="<?php echo $contact; ?>" required>
                    </div>
                    
                    <div>
                        <label>Mailing Address: </label>
                        <input type="email" name="mailing_address" value="<?php echo $email; ?>" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="subject_specialization" 
                               value="<?php echo ucwords($subject_specialization); ?>" required>
                    </div>
                </div>
